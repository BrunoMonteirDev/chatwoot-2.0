...
describe('parseOutgoingChatwootMessage', () => {
  it('aceita somente uma mensagem textual outgoing para contato WhatsApp', () => {
    expect(parseOutgoingChatwootMessage(payload)).toEqual({ messageId: 42, conversationId: 31, inboxId: 7, sourceId: 'whatsapp:5511999999999', number: '5511999999999', chatType: 'private', content: 'Olá, como posso ajudar?', attachments: [] });
  });
  ...
  it('usa o telefone do contato quando a inbox tem source id interno do Chatwoot', () => {
    ...
    })).toEqual({ messageId: 42, conversationId: 31, inboxId: 7, sourceId: '7c20c5f0-6f02-4d7e-a3c5-e3d4ad1bcb7d', number: '5511999999999', chatType: 'private', content: 'Olá, como posso ajudar?', attachments: [] });
  });
